...
public class UIBattleWindow : UIWindow
{
    ...
    public override void OnCreate()
    {
        ...
        _joystickCtrlMove.relativeTransform = GameManager.Instance.mainCamera.transform;
        ...
        _joystickCtrlTarget.relativeTransform = GameManager.Instance.mainCamera.transform;
